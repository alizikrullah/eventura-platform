...
export default function CreateEventPage() {
  ...
  const [ticketTypes, setTicketTypes] = useState<TicketTypeInput[]>([
    { id: generateId(), name: 'Regular', price: '0', available_quantity: '', description: '' },
  ]);
  ...
  const addTicketType = () => {
    setTicketTypes(prev => [
      ...prev,
      { id: generateId(), name: '', price: '0', available_quantity: '', description: '' },
    ]);
  };
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Isi detail event yang ingin kamu selenggarakan</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Contoh: Music Festival Jakarta 2026"
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 text-sm border rounded-lg outline-none transition-all ${
                          errors[`ticket_${tt.id}_name`]
                            ? 'border-red-400'
                            : 'border-gray-200 focus:ring-2 focus:ring-primary-900 focus:border-transparent'
                        }`}
                      />
                      {errors[`ticket_${tt.id}_name`] && (
                        <p className="text-xs text-red-500 mt-1">{errors[`ticket_${tt.id}_name`]}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0"
                        className={`w-full px-3 py-2 text-sm border rounded-lg outline-none transition-all ${
                          errors[`ticket_${tt.id}_price`]
                            ? 'border-red-400'
                            : 'border-gray-200 focus:ring-2 focus:ring-primary-900 focus:border-transparent'
                        }`}
                      />
                      {errors[`ticket_${tt.id}_price`] && (
                        <p className="text-xs text-red-500 mt-1">{errors[`ticket_${tt.id}_price`]}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => updateTicketType(tt.id, 'available_quantity', e.target.value)}
                        min={1}
                        placeholder="Contoh: 100"
                        className={`w-full px-3 py-2 text-sm border rounded-lg outline-none transition-all ${
                          errors[`ticket_${tt.id}_available_quantity`]
                            ? 'border-red-400'
                            : 'border-gray-200 focus:ring-2 focus:ring-primary-900 focus:border-transparent'
                        }`}
                      />
                      {errors[`ticket_${tt.id}_available_quantity`] && (
                        <p className="text-xs text-red-500 mt-1">{errors[`ticket_${tt.id}_available_quantity`]}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => updateTicketType(tt.id, 'description', e.target.value)}
          ...
          <div className="flex items-center gap-3 pb-8">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-3 rounded-xl bg-primary-900 hover:bg-primary-800 text-white text-sm font-bold transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
